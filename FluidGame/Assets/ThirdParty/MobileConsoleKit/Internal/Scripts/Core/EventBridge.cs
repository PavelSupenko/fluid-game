namespace MobileConsole
{
	public static class EventBridge
	{
        ...
        internal static event Callback OnMemoryVisibilityChanged;
		...
		public static void NotifyMemoryVisibilityChanged()
		{
			if (OnMemoryVisibilityChanged != null)
			{
				OnMemoryVisibilityChanged();
			}
		}
