...
namespace MobileConsole.UI
{
	public class ViewBuilder
	{
		...
		public RootNode _rootNode = new RootNode();
		...
		public CategoryNodeView CreateCategories(string path, Node parentNode = null)
		{
			if (parentNode == null)
		...
		public CategoryNodeView CreateCategories(string[] paths, Node parentNode = null)
		{
			if (paths == null || paths.Length == 0)
				return null;
		...
		public CategoryNodeView CreateCategory(string name)
		{
			return CreateCategory(name, IconCategory, IconCategoryClosed, string.Empty, _rootNode);
		}

		public CategoryNodeView CreateCategory(string name, string icon)
		{
			return CreateCategory(name, icon, string.Empty, string.Empty, _rootNode);
		}

		public CategoryNodeView CreateCategory(string name, string icon, string iconClose, string id, Node parentNode)
		{
		...
		public GenericNodeView AddButton(string name, GenericNodeView.Callback callback)
		{
			return AddButton(name, string.Empty, callback, string.Empty, _rootNode);
		}

		public GenericNodeView AddButton(string name, string icon, GenericNodeView.Callback callback)
		{
			return AddButton(name, icon, callback, string.Empty, _rootNode);
		}

		public GenericNodeView AddButton(string name, GenericNodeView.Callback callback, Node parentNode)
		{
			return AddButton(name, string.Empty, callback, string.Empty, parentNode);
		}

		public GenericNodeView AddButton(string name, string icon, GenericNodeView.Callback callback, Node parentNode)
		{
			return AddButton(name, icon, callback, string.Empty, parentNode);
		}

		public GenericNodeView AddButton(string name, string icon, GenericNodeView.Callback callback, string id, Node parentNode)
		{
			if (parentNode == null)
				parentNode = _rootNode;
		...
		public void AddCommandFields(Command command, Node parentNode)
		{
			if (parentNode == null)
				parentNode = _rootNode;
		...
		public void AddCommandField(Command command, string fieldName, string displayName)
		{
			AddCommandField(command, fieldName, displayName, string.Empty, _rootNode);
		}

		public void AddCommandField(Command command, string fieldName, string displayName, Node parentNode)
		{
			AddCommandField(command, fieldName, displayName, string.Empty, parentNode);
		}

		public void AddCommandField(Command command, string fieldName, string displayName, string id, Node parentNode)
		{
			if (parentNode == null)
				parentNode = _rootNode;
		...
		public CheckboxNodeView AddCheckbox(string name, bool isOn, CheckboxNodeView.Callback callback, Node parentNode)
		{
			return AddCheckbox(name, isOn, callback, string.Empty, parentNode);
		}

		public CheckboxNodeView AddCheckbox(string name, bool isOn, CheckboxNodeView.Callback callback, string id, Node parentNode)
		{
			if (parentNode == null)
				parentNode = _rootNode;
		...
		public InputNodeView AddInput(string name, string value, InputNodeView.Callback callback)
		{
			return AddInput(name, value, false, callback, string.Empty, _rootNode);
		}

		public InputNodeView AddInput(string name, string value, InputNodeView.Callback callback, Node parentNode)
		{
			return AddInput(name, value, false, callback, string.Empty, parentNode);
		}

		public InputNodeView AddInput(string name, string value, bool isNumeric, InputNodeView.Callback callback, string id, Node parentNode)
		{
			if (parentNode == null)
				parentNode = _rootNode;
		...
		public DropdownNodeView AddDropdown(string name, int index, string[] options, DropdownNodeView.Callback callback, Node parentNode)
		{
			return AddDropdown(name, index, options, callback, string.Empty, parentNode);
		}

		public DropdownNodeView AddDropdown(string name, int index, string[] options, DropdownNodeView.Callback callback, string id, Node parentNode)
		{
			if (parentNode == null)
				parentNode = _rootNode;
		...
		public SliderNodeView AddSlider(string name, float value, float min, float max, SliderNodeView.Callback callback)
		{
			return AddSlider(name, value, min, max, false, callback, string.Empty, _rootNode);
		}

		public SliderNodeView AddSlider(string name, float value, float min, float max, SliderNodeView.Callback callback, Node parentNode)
		{
			return AddSlider(name, value, min, max, false, callback, string.Empty, parentNode);
		}

		public SliderNodeView AddSlider(string name, float value, float min, float max, bool wholeNumbers, SliderNodeView.Callback callback, string id, Node parentNode)
		{
			if (parentNode == null)
				parentNode = _rootNode;
		...
		public GenericNodeView AddResizableText(string text)
		{
			return AddResizableText(text, string.Empty, string.Empty, _rootNode);
		}

		public GenericNodeView AddResizableText(string text, string icon)
		{
			return AddResizableText(text, icon, string.Empty, _rootNode);
		}

		public GenericNodeView AddResizableText(string text, Node parentNode)
		{
			return AddResizableText(text, string.Empty, string.Empty, parentNode);
		}

		public GenericNodeView AddResizableText(string text, string icon, Node parentNode)
		{
			return AddResizableText(text, icon, string.Empty, parentNode);
		}

		public GenericNodeView AddResizableText(string text, string icon, string id, Node parentNode)
		{
			if (parentNode == null)
				parentNode = _rootNode;
		...
		public virtual void OnCategoryToggled(GenericNodeView nodeView)
		{
		...
		public static int DefaultCompareNode(Node nodeA, Node nodeB)
		{
