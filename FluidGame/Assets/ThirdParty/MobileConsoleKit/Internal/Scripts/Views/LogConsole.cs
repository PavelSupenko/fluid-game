...
namespace MobileConsole
{
	...
	public class LogConsole : MonoBehaviour
	{
		...
		void Start()
		{
			...
			EventBridge.OnMemoryVisibilityChanged += OnMemoryVisibilityChanged;
		...
		void OnMemoryVisibilityChanged()
		{
			_memoryText.SetActive(LogConsoleSettings.Instance.showMemory);
		}
