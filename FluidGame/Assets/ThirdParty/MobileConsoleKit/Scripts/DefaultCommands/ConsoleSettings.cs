...
namespace MobileConsole
{
	...
	public class ConsoleSettings : Command
	{
		...
		[Variable(OnValueChanged = "UpdateShowMemory")]
		...
		public override void InitDefaultVariableValue()
		{
			...
			_showMemory = LogConsoleSettings.Instance.showMemory;
		...
		void UpdateShowMemory()
		{
			LogConsoleSettings.Instance.showMemory = _showMemory;
			EventBridge.NotifyMemoryVisibilityChanged();
		}
